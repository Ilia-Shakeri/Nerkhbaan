...
export const policies: Record<PolicyKind, { title: Text; body: Text }[]> = {
  privacy: [
    ...
    { title: { fa: 'دریافت‌کنندگان', en: 'Recipients' }, body: {
      fa: 'میزبان، ارائه‌دهنده ایمیل و سرویس اعلان مرورگر ممکن است داده لازم برای خدمت را پردازش کنند. وب‌هوک به مقصد انتخابی شما می‌رود. داده بازار در سرور از منابع بیرونی دریافت می‌شود. نمودار TradingView فقط پس از زدن دکمه بارگذاری می‌شود؛ سپس نشانی شبکه و مشخصات مرورگر برای آن سرویس فرستاده می‌شود و سیاست مستقل آن اعمال می‌شود. نام دیگر ارائه‌دهندگان و کشور پردازش باید توسط مالک تکمیل شود.',
      en: 'Hosting, email and browser push providers may process data needed for the service. Webhooks go to destinations you choose. Market data is fetched by the server. The TradingView chart loads only after you press its load button; that sends network and browser details to the service under its own policies. The operator must complete the other named providers and processing-country register.' } },
  ...
  cookies: [
    ...
    { title: { fa: 'رهگیری و رضایت', en: 'Tracking and consent' }, body: {
      fa: 'این نسخه تبلیغات یا تحلیل رفتار ندارد. نمودار TradingView فقط با اقدام صریح شما و برای همان بازدید بار می‌شود؛ نرخ‌بان این انتخاب را ذخیره نمی‌کند. آن سرویس ممکن است کوکی یا ذخیره‌سازی خودش را طبق سیاست مستقلش به‌کار ببرد. چون محتوای اختیاری پیش از انتخاب بار نمی‌شود، بنر «قبول همه» نشان داده نمی‌شود. برای پس‌گرفتن انتخاب، صفحه را تازه کنید یا داده سایت ثالث را از مرورگر پاک کنید.',
      en: 'This version has no advertising or behavioural analytics. The TradingView chart loads only through your explicit action for that visit; Nerkhbaan does not store the choice. That service may use its own cookies or storage under its independent policy. Because optional content is blocked before choice, no “accept all” banner is shown. Reload the page or clear third-party site data in your browser to withdraw the choice.' } },
  ],
  refunds: [

...
_PROVIDERS = (
    ...
    _provider(
        ...
        history_url=_setting_url("coingecko_api_base_url", "/coins/tether/market_chart"), history_parser_id="coingecko_tether_usd_history_v1",
        source_semantic=SourceSemantic.AGGREGATOR,
    ...
    _provider(
        ...
        "coingecko-simple-price/1.0.0", 120, rpm=10, rph=200, rpd=2000, interval=60,
        history_url=_setting_url("coingecko_api_base_url", "/coins/bitcoin/market_chart"), history_parser_id="coingecko_bitcoin_usd_history_v1",
        source_semantic=SourceSemantic.AGGREGATOR,
        source_family="coingecko", venue="opaque_aggregator",
        selected_price_semantic=PriceSemantic.REFERENCE,
    ),
    ...
    _provider(
        "persian_toolbox_gold24", "PersianToolbox Gold Reference",
        "GOLD_24K_TOMAN_GRAM", ProviderRole.FALLBACK, 20, "0.68",
        _setting_url("persian_toolbox_api_base_url", "/api/market"),
        "persian_toolbox_gold24_toman_v1", "persian-toolbox-market/1.0.0", 600,
        rpm=2, rph=20, rpd=288, interval=300,
        maximum_source_age_seconds=300,
        anchor_live_window_at_receive_time=True,
        source_semantic=SourceSemantic.REFERENCE_RATE,
